...
var len__4818__auto___40329 = arguments.length;
var i__4819__auto___40330 = (0);
while(true){
if((i__4819__auto___40330 < len__4818__auto___40329)){
args__4824__auto__.push((arguments[i__4819__auto___40330]));

var G__40331 = (i__4819__auto___40330 + (1));
i__4819__auto___40330 = G__40331;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq40250){
var G__40251 = cljs.core.first(seq40250);
var seq40250__$1 = cljs.core.next(seq40250);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40251,seq40250__$1);
}));
...
return cljs.core.some((function (p1__40253_SHARP_){
return (p1__40253_SHARP_ === object);
}),history);
});
...
if(cljs.core.truth_((function (){var and__4210__auto__ = cljs.core.map_QMARK_(history);
...
if(cljs.core.truth_((function (){var and__4210__auto__ = cljs.core.map_QMARK_(parent_object);
if(and__4210__auto__){
...
if(cljs.core.truth_((function (){var and__4210__auto__ = cljs.core.map_QMARK_(devtools.formatters.state.get_second_last_object_from_current_history());
if(and__4210__auto__){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4212__auto__ = path_info;
