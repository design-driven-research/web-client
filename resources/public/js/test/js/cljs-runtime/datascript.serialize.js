...
if((!((next_attr == null)))){
var G__47412 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(attrs,next_attr);
attrs = G__47412;
continue;
} else {
 ...
 * avet     :: [<index in eavt> ...]
 */
datascript.serialize.serializable_impl = (function datascript$serialize$serializable_impl(db,p__47242){
var map__47243 = p__47242;
var map__47243__$1 = cljs.core.__destructure_map(map__47243);
var freeze_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__47243__$1,new cljs.core.Keyword(null,"freeze-fn","freeze-fn",-575885995),cljs.core.pr_str);
...
var idx = (function (){var or__4212__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(_STAR_kw_map),kw);
...
var e = d.e;
var a = (function (){var G__47249 = d.a;
return (attrs_map.cljs$core$IFn$_invoke$arity$1 ? attrs_map.cljs$core$IFn$_invoke$arity$1(G__47249) : attrs_map.call(null,G__47249));
})();
var v = write_v(d.v);
...
var schema = (function (){var G__47254 = new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1(db);
return (freeze_fn.cljs$core$IFn$_invoke$arity$1 ? freeze_fn.cljs$core$IFn$_invoke$arity$1(G__47254) : freeze_fn.call(null,G__47254));
})();
...
(datascript.serialize.from_serializable.cljs$core$IFn$_invoke$arity$2 = (function (from,p__47299){
var map__47303 = p__47299;
var map__47303__$1 = cljs.core.__destructure_map(map__47303);
var thaw_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__47303__$1,new cljs.core.Keyword(null,"thaw-fn","thaw-fn",-240544261),clojure.edn.read_string);
var tx0 = datascript.serialize.dict_get(from,"tx0");
var schema = (function (){var G__47307 = datascript.serialize.dict_get(from,"schema");
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__47307) : thaw_fn.call(null,G__47307));
})();
var _ = (function (){var fexpr__47331 = new cljs.core.Var(function(){return datascript.db.validate_schema;},new cljs.core.Symbol("datascript.db","validate-schema","datascript.db/validate-schema",-783030261,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"datascript.db","datascript.db",-444456104,null),new cljs.core.Symbol(null,"validate-schema","validate-schema",758884380,null),"datascript/db.cljc",23,1,718,718,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"schema","schema",58529736,null)], null)),null,(cljs.core.truth_(datascript.db.validate_schema)?datascript.db.validate_schema.cljs$lang$test:null)]));
return (fexpr__47331.cljs$core$IFn$_invoke$arity$1 ? fexpr__47331.cljs$core$IFn$_invoke$arity$1(schema) : fexpr__47331.call(null,schema));
})();
...
var pred__47333 = cljs.core._EQ__EQ_;
var expr__47334 = marker;
if(cljs.core.truth_((pred__47333.cljs$core$IFn$_invoke$arity$2 ? pred__47333.cljs$core$IFn$_invoke$arity$2((0),expr__47334) : pred__47333.call(null,(0),expr__47334)))){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(keywords,datascript.serialize.array_get(v,(1)));
} else {
if(cljs.core.truth_((pred__47333.cljs$core$IFn$_invoke$arity$2 ? pred__47333.cljs$core$IFn$_invoke$arity$2((1),expr__47334) : pred__47333.call(null,(1),expr__47334)))){
var G__47336 = datascript.serialize.array_get(v,(1));
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__47336) : thaw_fn.call(null,G__47336));
} else {
if(cljs.core.truth_((pred__47333.cljs$core$IFn$_invoke$arity$2 ? pred__47333.cljs$core$IFn$_invoke$arity$2((2),expr__47334) : pred__47333.call(null,(2),expr__47334)))){
return Infinity;
} else {
if(cljs.core.truth_((pred__47333.cljs$core$IFn$_invoke$arity$2 ? pred__47333.cljs$core$IFn$_invoke$arity$2((3),expr__47334) : pred__47333.call(null,(3),expr__47334)))){
return -Infinity;
} else {
if(cljs.core.truth_((pred__47333.cljs$core$IFn$_invoke$arity$2 ? pred__47333.cljs$core$IFn$_invoke$arity$2((4),expr__47334) : pred__47333.call(null,(4),expr__47334)))){
return NaN;
} else {
...
var aevt = (function (){var G__47365 = datascript.serialize.dict_get(from,"aevt");
if((G__47365 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__47276_SHARP_){
return (eavt[p1__47276_SHARP_]);
}),G__47365);
}
})();
var avet = (function (){var G__47366 = datascript.serialize.dict_get(from,"avet");
if((G__47366 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__47277_SHARP_){
return (eavt[p1__47277_SHARP_]);
}),G__47366);
}
})();
return datascript.db.map__GT_DB(new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"rschema","rschema",-1196134054),(function (){var G__47368 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","ident","db/ident",-737096),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","unique","db/unique",329396388),new cljs.core.Keyword("db.unique","identity","db.unique/identity",1675950722)], null)], null),schema], 0));
var fexpr__47367 = new cljs.core.Var(function(){return datascript.db.rschema;},new cljs.core.Symbol("datascript.db","rschema","datascript.db/rschema",1982085018,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"datascript.db","datascript.db",-444456104,null),new cljs.core.Symbol(null,"rschema","rschema",444397473,null),"datascript/db.cljc",15,1,686,686,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"schema","schema",58529736,null)], null)),":db/unique           => #{attr ...}\n   :db.unique/identity  => #{attr ...}\n   :db.unique/value     => #{attr ...}\n   :db/index            => #{attr ...}\n   :db.cardinality/many => #{attr ...}\n   :db.type/ref         => #{attr ...}\n   :db/isComponent      => #{attr ...}\n   :db.type/tuple       => #{attr ...}\n   :db/attrTuples       => {attr => {tuple-attr => idx}}",(cljs.core.truth_(datascript.db.rschema)?datascript.db.rschema.cljs$lang$test:null)]));
return (fexpr__47367.cljs$core$IFn$_invoke$arity$1 ? fexpr__47367.cljs$core$IFn$_invoke$arity$1(G__47368) : fexpr__47367.call(null,G__47368));
})(),new cljs.core.Keyword(null,"eavt","eavt",-666437073),me.tonsky.persistent_sorted_set.from_sorted_array(datascript.db.cmp_datoms_eavt,eavt),new cljs.core.Keyword(null,"aevt","aevt",-585148059),me.tonsky.persistent_sorted_set.from_sorted_array(datascript.db.cmp_datoms_aevt,aevt),new cljs.core.Keyword(null,"avet","avet",1383857032),me.tonsky.persistent_sorted_set.from_sorted_array(datascript.db.cmp_datoms_avet,avet),new cljs.core.Keyword(null,"max-eid","max-eid",2134868075),datascript.serialize.dict_get(from,"max-eid"),new cljs.core.Keyword(null,"max-tx","max-tx",1119558339),datascript.serialize.dict_get(from,"max-tx"),new cljs.core.Keyword(null,"hash","hash",-13781596),cljs.core.atom.cljs$core$IFn$_invoke$arity$1((0))], null));
}));
