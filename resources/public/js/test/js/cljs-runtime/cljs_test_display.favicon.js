...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50370_SHARP_){
return html_coll.item(p1__50370_SHARP_);
...
return cljs.core.some((function (p1__50381_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__50381_SHARP_);
...
var ctx_50416 = cvs.getContext("2d");
(ctx_50416.fillStyle = color);

ctx_50416.fillRect((0),(0),size,size);
