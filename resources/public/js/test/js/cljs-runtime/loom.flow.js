...
return ((function (){var or__4212__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(flow,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [v2,v1], null));
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return (0);
}
})() + ((function (){var or__4212__auto__ = (capacity.cljs$core$IFn$_invoke$arity$2 ? capacity.cljs$core$IFn$_invoke$arity$2(v1,v2) : capacity.call(null,v1,v2));
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return (0);
}
})() - (function (){var or__4212__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(flow,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [v1,v2], null));
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return (0);
...
while(true){
var temp__5751__auto__ = cljs.core.first(adj_list);
if(cljs.core.truth_(temp__5751__auto__)){
var vec__46437 = temp__5751__auto__;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46437,(0),null);
var neighbours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46437,(1),null);
var G__46535 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(out,node,(- cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.vals(neighbours))));
var G__46536 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(cljs.core._PLUS_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([in$,neighbours], 0));
var G__46537 = cljs.core.next(adj_list);
out = G__46535;
in$ = G__46536;
adj_list = G__46537;
continue;
...
return ((((function (){var or__4212__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(balance,source);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return (0);
}
})() <= (0))) && ((((((function (){var or__4212__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(balance,source);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return (0);
}
})() + (function (){var or__4212__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(balance,sink);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return (0);
...
return cljs.core.every_QMARK_((function (p__46456){
var vec__46470 = p__46456;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46470,(0),null);
var flow_to_successors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46470,(1),null);
return cljs.core.every_QMARK_((function (p__46473){
var vec__46474 = p__46473;
var neighbor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46474,(0),null);
var flow_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46474,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46492_SHARP_){
var or__4212__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(weight_fn,p1__46492_SHARP_);
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return (0);
...
return cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46506_SHARP_){
return (loom.flow.residual_capacity(capacity,flow,vertex,p1__46506_SHARP_) > (0));
...
var forward_flow = (function (){var or__4212__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(flow,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [vn0,vn1], null));
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return (0);
...
var forward_capacity = ((function (){var or__4212__auto__ = (capacity.cljs$core$IFn$_invoke$arity$2 ? capacity.cljs$core$IFn$_invoke$arity$2(vn0,vn1) : capacity.call(null,vn0,vn1));
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return (0);
...
var reverse_flow = (function (){var or__4212__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(flow,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [vn1,vn0], null));
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
} else {
return (0);
...
var forward_increase = (function (){var x__4298__auto__ = forward_capacity;
var y__4299__auto__ = increase;
...
var G__46542 = flow_2;
var G__46543 = capacity;
var G__46544 = cljs.core.next(path);
var G__46545 = increase;
flow = G__46542;
capacity = G__46543;
path = G__46544;
increase = G__46545;
...
while(true){
var temp__5751__auto__ = loom.flow.bf_find_augmenting_path(successors,predecessors,capacity,flow,source,sink);
if(cljs.core.truth_(temp__5751__auto__)){
var path = temp__5751__auto__;
var G__46551 = successors;
var G__46552 = predecessors;
var G__46553 = capacity;
var G__46554 = source;
var G__46555 = sink;
var G__46556 = loom.flow.augment_along_path(flow,capacity,path,loom.flow.min_weight_along_path(path,cljs.core.partial.cljs$core$IFn$_invoke$arity$3(loom.flow.residual_capacity,capacity,flow)));
successors = G__46551;
predecessors = G__46552;
capacity = G__46553;
source = G__46554;
sink = G__46555;
flow = G__46556;
