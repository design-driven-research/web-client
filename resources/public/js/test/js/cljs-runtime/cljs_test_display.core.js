...
var node = (function (){var G__50603 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__50604 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__50605 = style_string_50816;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__50603,G__50604,G__50605) : cljs_test_display.core.n.call(null,G__50603,G__50604,G__50605));
})();
...
var len__4818__auto___50819 = arguments.length;
var i__4819__auto___50820 = (0);
while(true){
if((i__4819__auto___50820 < len__4818__auto___50819)){
args__4824__auto__.push((arguments[i__4819__auto___50820]));

var G__50821 = (i__4819__auto___50820 + (1));
i__4819__auto___50820 = G__50821;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq50606){
var G__50607 = cljs.core.first(seq50606);
var seq50606__$1 = cljs.core.next(seq50606);
var G__50608 = cljs.core.first(seq50606__$1);
var seq50606__$2 = cljs.core.next(seq50606__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50607,G__50608,seq50606__$2);
}));
...
var vec__50630 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50630,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50630,(1),null);
var G__50633 = cljs.core.PersistentArrayMap.EMPTY;
var G__50633__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50633,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__50633);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50633__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__50633__$1;
}
} else {
...
return (function() { 
var G__50826__delegate = function (klass,contents){
var vec__50641 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50641,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50641,(1),null);
...
var G__50826 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__50827__i = 0, G__50827__a = new Array(arguments.length -  1);
while (G__50827__i < G__50827__a.length) {G__50827__a[G__50827__i] = arguments[G__50827__i + 1]; ++G__50827__i;}
  contents = new cljs.core.IndexedSeq(G__50827__a,0,null);
} 
return G__50826__delegate.call(this,klass,contents);};
G__50826.cljs$lang$maxFixedArity = 1;
G__50826.cljs$lang$applyTo = (function (arglist__50828){
var klass = cljs.core.first(arglist__50828);
var contents = cljs.core.rest(arglist__50828);
return G__50826__delegate(klass,contents);
});
G__50826.cljs$core$IFn$_invoke$arity$variadic = G__50826__delegate;
return G__50826;
})()
;
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__50662){
var map__50663 = p__50662;
var map__50663__$1 = cljs.core.__destructure_map(map__50663);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50663__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50663__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__50671){
var map__50675 = p__50671;
var map__50675__$1 = cljs.core.__destructure_map(map__50675);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50675__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50675__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__50681){
var map__50683 = p__50681;
var map__50683__$1 = cljs.core.__destructure_map(map__50683);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50683__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50683__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__50691_SHARP_){
return cljs.core.cons(new_current_node,p1__50691_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__50696 = cljs_test_display.core.current_var_info();
var map__50696__$1 = cljs.core.__destructure_map(map__50696);
var info = map__50696__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50696__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50696__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50696__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__50694_SHARP_){
return cljs.core.cons(node,p1__50694_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__50699){
var map__50701 = p__50699;
var map__50701__$1 = cljs.core.__destructure_map(map__50701);
var m = map__50701__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50701__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50701__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50701__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50701__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__50710 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__50710) : formatter_fn.call(null,G__50710));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__50711 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__50711) : formatter_fn.call(null,G__50711));
})()], 0));
});
...
var temp__5753__auto___50833 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___50833)){
var message_50834 = temp__5753__auto___50833;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_50834], 0));
} else {
}
...
var temp__5753__auto___50835 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___50835)){
var message_50836 = temp__5753__auto___50835;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_50836], 0));
} else {
}
