...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_46146 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_46146(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_46147 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_46147(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_46148 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_46148(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_46149 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_46149(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_46160 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_46160(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_46162 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_46162(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__46129,callback){
var map__46130 = p__46129;
var map__46130__$1 = cljs.core.__destructure_map(map__46130);
var input = map__46130__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46130__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46130__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
