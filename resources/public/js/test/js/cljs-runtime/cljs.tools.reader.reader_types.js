...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41083 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41083(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41087 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41087(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41089 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41089(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41090 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41090(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41092 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41092(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41093 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41093(reader);
}
});
...
var G__41181 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41182 = s.append(c);
c = G__41181;
s = G__41182;
continue;
}
